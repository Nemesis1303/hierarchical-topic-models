...
def main(nw=0, iter_=0):
    ...
    # Execute command
    cmd = f"python /export/usuarios_ml4ds/lbartolome/hierarchical-topic-models/code/topicmodeling/topicmodeling.py --preproc --config {configFile.resolve().as_posix()} --nw {str(nw)}"
