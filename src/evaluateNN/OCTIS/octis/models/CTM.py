...
class CTM(AbstractModel):
    ...
    def __init__(
        ...
        dropout_thetas=0.2, dropout_inf=0.2, learn_priors=True, batch_size=64, lr=2e-3, momentum=0.99,
        ...
        self.hyperparameters['dropout_thetas'] = dropout_thetas
        self.hyperparameters['dropout_inf'] = dropout_inf
    ...
    def train_model(self, dataset, hyperparameters=None, top_words=10):
        ...
        if self.use_partitions:
            ...
            train_emb, validation_emb, test_emb = dataset.get_partitioned_embeddings(
                use_validation=True)
            ...
            x_train, x_test, x_valid, input_size = self.preprocess(
                ...
                bert_model=self.hyperparameters["bert_model"], train_emb=train_emb, val_emb=validation_emb, test_emb=test_emb)
            ...
            self.model = ctm.CTM(
                ...
                dropout_thetas=self.hyperparameters['dropout_thetas'],
                dropout_inf=self.hyperparameters['dropout_inf'],
            ...
            data_embedddings = dataset.get_embeddings()
            x_train, input_size = self.preprocess(
                self.vocab, train=data_corpus,
                bert_train_path=(
                    self.hyperparameters['bert_path'] + "_train.pkl"),
                bert_model=self.hyperparameters["bert_model"], train_emb=data_embedddings)
    ...
    def preprocess(
        vocab, train, bert_model, test=None, validation=None,
            ...
            train_emb=None, test_emb=None, val_emb=None):
        ...
        if test is not None and validation is not None:
            ...
            if val_emb is None:
                b_val = CTM.load_bert_data(
                    bert_val_path, validation, bert_model)
            else:
                b_val = val_emb
