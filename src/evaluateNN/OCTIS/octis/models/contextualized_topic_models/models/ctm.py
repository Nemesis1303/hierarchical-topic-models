...
class CTM(object):
    ...
    def __init__(
        ...
        activation='softplus', dropout_thetas=0.2, dropout_inf=0.2, learn_priors=True, batch_size=64,
        ...
        assert dropout_thetas >= 0, "dropout must be >= 0."
        assert dropout_inf >= 0, "dropout must be >= 0."
        ...
        self.dropout_thetas = dropout_thetas
        ...
        self.model = DecoderNetwork(
            ...
            dropout_thetas, dropout_inf, self.learn_priors, self.topic_prior_mean,
    ...
    def fit(self, train_dataset, validation_dataset=None,
        ...
        if verbose:
            print("Settings: \n\
                ...
                self.hidden_sizes, self.activation, self.dropout_thetas,
    ...
    def _format_file(self):
        model_dir = (
            ...
            "lr_{}_mo_{}_rp_{}".format(
                ...
                self.dropout_thetas, self.lr, self.momentum,
