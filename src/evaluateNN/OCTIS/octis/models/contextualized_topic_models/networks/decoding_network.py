...
class DecoderNetwork(nn.Module):
    ...
    def __init__(self, input_size, bert_size, infnet, n_components=10, model_type='prodLDA',
                 hidden_sizes=(100,100), activation='softplus', dropout_thetas=0.2, dropout_inf=0.2,
        ...
        if infnet == "zeroshot":
            self.inf_net = ContextualInferenceNetwork(
                input_size, bert_size, n_components, hidden_sizes, activation, dropout_inf)
        ...
        # dropout on theta
        self.drop_theta = nn.Dropout(p=self.dropout_thetas)
